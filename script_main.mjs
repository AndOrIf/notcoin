...
async function I({routeId: e, pathVariables: i, localeId: a}) {
    let o = z[e].page.preload()
      , s = t(S, {
        ...
        siteCanonicalURL: `https://www.probablynothing.xyz`,
...
async function R(e, t) {
    function n(e, t, n=!0) {
        if (e.caught || h.__framer_hadFatalError)
            return;
...
`, e, r);
    ...
    try {
        ...
        e ? (P(`framer-rewrite-breakpoints`, () => {
            k(c),
            h.__framer_onRewriteBreakpoints?.(c)
        }
        ),
        i( () => {
            D(),
...
e(( () => {
    ...
    V = {},
    H = `875a976b4d68a05acd48eb15a1b5e414cda1158b652dfcbb377eeb22f7a703dc`,
    U = typeof document < `u`,
    U) {
